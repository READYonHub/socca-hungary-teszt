...
if (!isset($_SESSION['login'])) {
    ...
    if (isset($_POST["create"])) {
        ...
        if (move_uploaded_file(
            ...
            $_SERVER["DOCUMENT_ROOT"] . '../images/palyers_profile_pic/' . $profile_pic
        )) {
            $target_file    =   $_SERVER['DOCUMENT_ROOT'] . '/images/players_profile_pic/' . $profile_pic;
...
<?php
            } else if ($_FILES["profile_pic"]["name"] > 500000) { ?>
    <script>
